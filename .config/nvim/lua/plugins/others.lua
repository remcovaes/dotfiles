return {
	...
	{ -- Fuzzy Finder (files, lsp, etc)
		...
		config = function()
			...
			vim.keymap.set("n", "<leader>sf", function() builtin.git_files({ show_untracked = true }) end, { desc = "[S]earch [F]iles" })
	...
	{ -- Autoformat
		...
		opts = {
			...
			-- 	local disable_filetypes = { c = true, cpp = true, ts = true, tsx = true, js = true, jsx = true }
